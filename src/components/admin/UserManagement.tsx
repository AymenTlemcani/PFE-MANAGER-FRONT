  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Import Users</h3>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">User List</h3>
        <UserList
          users={users}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {formData.role === 'teacher' && (
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="isResponsible" className="text-sm text-gray-700 dark:text-gray-300">
