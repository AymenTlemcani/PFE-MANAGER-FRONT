        ...
        <div key={project.id} className="py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">Student: {project.student}</p>
              <p className="mt-1 text-sm text-gray-500">Supervisor: {project.supervisor}</p>
            </div>
    ...
    <div className="divide-y divide-gray-200">
      {proposals.map((proposal) => (
        <div key={proposal.id} className="py-4">
          ...
          <p className="mt-1 text-sm text-gray-500">Requirements: {proposal.requirements}</p>
          <div className="mt-2 flex items-center justify-between">
            <p className="text-sm text-gray-500">Submitted: {proposal.submittedDate}</p>
